...
namespace PFA.Library.Migrations
{
    ...
    [Migration("20230523101815_isPresentAdded")]
    partial class isPresentAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PFA.Library.Models.ExamEtudiant", b =>
                {
                    ...
                    b.ToTable("ExamEtudiants");
                });

            modelBuilder.Entity("PFA.Library.Models.ExamSurveillant", b =>
                {
                    ...
                    b.HasKey("SurveillantId", "ExamId");

                    b.HasIndex("ExamId");

                    b.HasIndex("SalleId");

                    b.ToTable("ExamSurveillants");
                });
            ...
            modelBuilder.Entity("PFA.Library.Models.ExamSurveillant", b =>
                {
                    ...
                    b.HasOne("PFA.Library.Models.Surveillant", "Surveillant")
                        .WithMany("ExamSurveillants")
